          ...
          <div className="col-span-9 h-full ">
            ...
            <div className="grid grid-cols-10 gap-6">
              ...
              <div className="col-span-10  ">
                ...
                {/* //! نمایش تعداد دوره های کاربر*/}
                <div className=" font-yekan text-[18px] text-first rounded-xl px-6 my-3">
                    <span> تعداد دوره های شما:</span>
                    <span className="px-2">{MyCourse.length} </span>
                </div>
                {/* //! جدول مربوط به لیست دوره های کاربر*/}

                <div className="overflow-x-auto">
                  <table
                    className={`table table-zebra bg-white shadow-xl px-1 grid gap-2 grid-cols-[75px_auto_auto_110px_110px_120px_50px] items-center text-center text-sm  text-gray-800 p-3 border-b`}
                  >
                    {/* head */}
                    <thead>
                      <tr>
...
export default Dashboard_MyCourse;
